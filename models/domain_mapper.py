...
class LitDomainMapper(pl.LightningModule):
    ...
    def get_loss_functions(self):
        ...
        return (
            loss_fn_transition_model,
            loss_fn_kinematics_AB,
            loss_fn_kinematics_BA,
            loss_soft_dtw_AB,
            loss_soft_dtw_BA,
        )
    ...
    def get_train_dataloader(self, data_file):
        ...
        dataloader_train = DataLoader(
            TensorDataset(trajectories_states_train, trajectories_actions_train),
    ...
    def get_validation_dataloader(self, data_file):
        ...
        dataloader_validation = DataLoader(
            TensorDataset(trajectories_states_test, trajectories_actions_test),
            batch_size=self.hparams.batch_size,
            num_workers=self.hparams.num_workers,
            pin_memory=True,
        )
